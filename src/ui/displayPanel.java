...
public class displayPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("110-134");

        jLabel10.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("65-79");
        ...
        for(House house: selectedCommunity.getHouses()){
            for(Person person: house.getPersons()){
                if(person instanceof Patient){
                    if(((Patient) person).getEncounterHistory().getEncounterHistory().isEmpty()){
                        continue;
                    }
                    for(Encounter encounter:((Patient) person).getEncounterHistory().getEncounterHistory()){
                    int Upperbp=encounter.getVitalsigns().getHighbloodPressure();
                    int Lowerbp=encounter.getVitalsigns().getLowbloodPressure();
